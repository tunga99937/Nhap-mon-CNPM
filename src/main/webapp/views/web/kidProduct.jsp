					...
					<c:forEach var="j" begin="0" end="2">
						<div class="col-lg-4 mb-4">
							<div class="card h-100">
								<img class="card-img"
									src="Image/Product/Kids/${product.get(18+i*3+j).get(0).image}">
								<div class="card-body">
									<h4>${product.get(18+i*3 +j).get(1).productName}</h4>
								</div>
								<div class="card-footer">

									<p class="text-color-secondary ">${product.get(18+i*3 +j).get(1).price}</p>
